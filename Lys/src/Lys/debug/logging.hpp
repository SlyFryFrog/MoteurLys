...
#define LYS_WARNING(...) Lys::Logger::get_singleton()->log(Lys::LogLevel::WARNING, __VA_ARGS__)
#define LYS_ERROR(...) Lys::Logger::get_singleton()->log(Lys::LogLevel::ERROR, __VA_ARGS__)
#define LYS_CRITICAL(...) Lys::Logger::get_singleton()->log(Lys::LogLevel::CRITICAL, __VA_ARGS__)
