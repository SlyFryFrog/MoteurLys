...
namespace LilyPad
{
	...
	// void Vertices::upload_vertices(unsigned int &VAO, unsigned int &VBO, int row_size)
	// {
	...
	// VerticesC::VerticesC() { Vertices::_row_size = 8; }

	// void VerticesC::set_vertices(std::vector<VertexC> vertices) { _vertices = vertices; }

	// void VerticesC::add_vertex(VertexC vertex) { _vertices.push_back(vertex); }

	// void VerticesC::upload_vertices(unsigned int &VAO, unsigned int &VBO, int row_size)
	// {
